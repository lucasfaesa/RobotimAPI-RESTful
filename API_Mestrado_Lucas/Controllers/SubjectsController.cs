...
namespace API_Mestrado_Lucas.Controllers
{
    ...
    public class SubjectsController : ControllerBase
    {
        ...
        {
            var subject = await _context.Subjects.Where(x=>x.Id == id).Include(x=>x.SubjectThemes).AsNoTracking().FirstOrDefaultAsync();
        ...
        {
            var subjects = await _context.Subjects.Include(x=>x.SubjectThemes).AsNoTracking().ToListAsync();
        ...
        {
            _context.Subjects.Add(subject.Adapt<Subject>());
            await _context.SaveChangesAsync();
